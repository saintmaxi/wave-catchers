...
const cocoImgURL =
  "https://github.com/saintmaxi/wave-catchers/blob/main/images/coco.png?raw=true";
const V2_START = 33;
...
const newMarket = new ethers.Contract(
  newMarketAddress,
  newMarketAbi(),
  provider
);
  ...
  for (const chunk of chunks) {
    await Promise.all(
      chunk.map(async (i) => {
        ...
        if (network == "eth") {
          networkLogo =
            "https://github.com/saintmaxi/wave-catchers-prod/blob/main/images/eth.png?raw=true";
        } else if (network == "arb") {
          networkLogo =
            "https://github.com/saintmaxi/wave-catchers-prod/blob/main/images/arbitrum.png?raw=true";
        }
